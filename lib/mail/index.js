...
exports.http_add = function (req, res) {
  ...
  exports.add(path, function (err, result) {
...
exports.http_indexing = function (req, res) {
  ...
  searcher.indexing(target, source, function (err) {
    ...
    target.option.out = 'mails.mutual';
...
exports.http_search = function (req, res) {

  var condition = {};
  if (req.query.sSearch) {
    condition['tf'] = req.query.sSearch;
  }

  var result_collection = 'mails.search.result';
      ...
      searcher.cmdscale(target, source, function (err) {
        ...
        mongo.open(function (err, db) {
          if (err) {
            ...
            var collection = db.collection(result_collection);
            collection.find({}, {sort: {tf: -1}}).toArray(function (err, results) {
              db && db.close();
