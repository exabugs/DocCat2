...
exports.search = function (collection, condition, text, callback) {
  ...
  tasks.push(function (keyword, done) {
    ...
    var map = function () {
      emit(this._id, util.innerproduct(this.metadata.tf, keyword));
     // emit(this._id, this.filename);
    };
    ...
    if (0 < words.length) {
      condition["metadata.tf.k"] = {$in: words};
    }
    ...
    collection.mapReduce(
      ...
      reduce,
      {
        scope: {util: util, keyword: keyword},
        query: condition,
        //out: out
        out: {inline: 1}
      },
...
exports.patch = function (db, src, _id, out, callback) {
  ...
  gs.open(function (err, gs) {
    err && callback(err);
    exports.parse(gs, function (err, result, total) {
...
exports.parse = function (gs, callback) {
