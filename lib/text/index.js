...
exports.search = function (collection, condition, text, callback) {
  ...
  tasks.push(function (keyword, done) {
    ...
    var freq_coll = 'mails.df';
//    var freq = db.collection(freq_coll);
//    freq.find()
    done(null, keyword, words);
  });
  tasks.push(function (keyword, words, done) {
    ...
    collection.mapReduce(
      function () {
        var array = extend.getValueEx(this, attr);
      ...
      {
        scope: {util: util, extend: extend, keyword: keyword, attr: attr},
        query: condition,
        //out: out
        out: {inline: 1}
      },
