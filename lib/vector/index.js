...
var mr_util = new Util();
for (var x in Util.prototype) {
  mr_util[x] = Util.prototype[x];
}
...
exports.cosine = function (collection, condition, target, field, keyword, weight, out, callback) {
  ...
  collection.mapReduce(
    function () {
      ...
      // コサイン値(類似度)を求める
      var cosine = util.cosine(params.keyword, array, params.field.key, params.field.val);
